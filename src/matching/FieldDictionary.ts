...
export const FIELD_RULES: FieldRule[] = [
  ...
  { fieldType: 'LOCATION', profilePath: 'basic.currentCity', exact: ['现居住地'], aliases: ['居住地', 'currentlocation'], valueKind: 'text' },
  { fieldType: 'LOCATION', profilePath: 'basic.hukouPlace', exact: ['户口所在地'], aliases: ['户籍所在地', '户口'], valueKind: 'text' },
  { fieldType: 'OTHER', profilePath: 'basic.jobStatus', exact: ['求职状态'], aliases: ['您的求职状态是', 'jobstatus'], valueKind: 'text' },
